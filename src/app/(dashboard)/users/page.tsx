                            ...
                            <div className="grid gap-3">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={`w-full border-2 p-3 pr-12 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 transition placeholder:text-gray-300${createUserForm.errors.password ? ' border-red-500' : ' border-gray-200'}`}
                                    />
                                    {showPassword ? (
                                        <EyeOff
                            ...
                            <div className="grid gap-3">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={`w-full border-2 p-3 pr-12 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 transition placeholder:text-gray-300${createUserForm.errors.confirmPassword ? ' border-red-500' : ' border-gray-200'}`}
                                    />
                                    {showConfirmPassword ? (
                                        <EyeOff
                                            className="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer text-gray-500 hover:text-gray-700"
                            ...
                            <div className="grid gap-3">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={`w-full border-2 p-3 pr-12 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 transition placeholder:text-gray-300${editUserForm.editErrors.password ? ' border-red-500' : ' border-gray-200'}`}
                                    />
                                    {showEditPassword ? (
                                        <EyeOff
                                            className="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer text-gray-500 hover:text-gray-700"
                            ...
                            <div className="grid gap-3">
                                ...
                                <div className="relative">
                                    <Input
                                        ...
                                        className={`w-full border-2 p-3 pr-12 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 transition placeholder:text-gray-300${editUserForm.editErrors.confirmPassword ? ' border-red-500' : ' border-gray-200'}`}
                                    />
                                    {showEditConfirmPassword ? (
                                        <EyeOff
                                            className="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer text-gray-500 hover:text-gray-700"
                                            onClick={() => setShowEditConfirmPassword(false)}
                                        />
                                    ) : (
                                        <Eye
                                            className="absolute right-4 top-1/2 transform -translate-y-1/2 cursor-pointer text-gray-500 hover:text-gray-700"
                                            onClick={() => setShowEditConfirmPassword(true)}
                                        />
                                    )}
                                </div>
